package edu.cornell.SocialDPU.UtilLibs;


/**
 * This is a utility class for converting any datatype or datatypearray to an byte array
 * This class also contains functions to convert byte array back to data type
 * @author shuva
 *
 */
